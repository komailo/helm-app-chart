              ...
              command:
                ...
                - |
                  ...
                  if [ -n "${RESTIC_ssh_private_key:-}" ]; then
                    ...
                    echo '#!/bin/sh' > "$SSH_DIR/ssh-wrapper.sh"
                    echo 'exec ssh -i /cache/restic/.ssh/id_rsa -o UserKnownHostsFile=/cache/restic/.ssh/known_hosts -o IdentitiesOnly=yes -o StrictHostKeyChecking=yes "$@"' >> "$SSH_DIR/ssh-wrapper.sh"
