...
- app-chart.deployment.livenessProbe: emits optional liveness probes (exec or HTTP GET) configured via `apps.<name>.livenessProbe`.
- app-chart.deployment.readinessProbe: emits optional readiness probes (exec or HTTP GET) configured via `apps.<name>.readinessProbe`.
